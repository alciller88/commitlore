...
func TestResolveAlias_Ollama(t *testing.T) {
	provider, url, model, requiresKey := ResolveAlias("ollama", "")
...
func TestResolveAlias_Groq(t *testing.T) {
	provider, url, model, requiresKey := ResolveAlias("groq", "")
	assert.Equal(t, "openai", provider)
...
func TestResolveAlias_OllamaWithCustomURL(t *testing.T) {
	provider, url, model, _ := ResolveAlias("ollama", "http://custom:8080/v1")
	assert.Equal(t, "openai", provider)
...
func TestResolveAlias_NotAnAlias(t *testing.T) {
	provider, url, model, requiresKey := ResolveAlias("anthropic", "")
...
func TestResolveAlias_OpenAIPassthrough(t *testing.T) {
	provider, url, model, requiresKey := ResolveAlias("openai", "https://custom.api.com/v1")
	assert.Equal(t, "openai", provider)
